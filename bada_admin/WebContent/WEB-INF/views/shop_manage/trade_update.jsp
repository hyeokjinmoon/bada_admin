            ...
            <div class="col-sm-offset-2 col-md-offset-2 main-content">
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="b_title" class="col-md-2 text-right">거래일련번호</label>
                    ...
                    <div class="form-group">
                        <label for="s_price" class="col-md-2 text-right">상품이미지</label>
                        <div class="col-md-8">
                            <img class="thumbnail" src="http://placehold.it/50x50" alt="" width="50px" />
                            <input type="file" name="s_price" id="s_price" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
