...
@WebServlet("/member/sale_request_edit.do")
public class SaleRequestEdit extends BaseController {

	private static final long serialVersionUID = 5224369975731831595L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		return "member/sale_request_edit";
	}
