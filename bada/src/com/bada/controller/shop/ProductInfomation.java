...
@WebServlet("/shop/product_info.do")
public class ProductInfomation extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String buildLine = builder.toString();
			buildLine = URLDecoder.decode(buildLine, "UTF-8");
			System.out.println(buildLine);
			out.println(buildLine);
			rd.close();
		} catch (Exception e) {
