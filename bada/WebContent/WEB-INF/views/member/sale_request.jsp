    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-10 main-content">
                ...
                <form class="form-horizontal" id="myform" method="post" action="${pageContext.request.contextPath}/member/sale_request_ok.do">
                	<input type="hidden" name="member_id" value="${loginInfo.id }"/>
                    <div class="form-group">
                        <label for="sale_type" class="col-md-2">신청종류*</label>
                        <div class="col-md-8">
                            <label for="s_type"><input type="radio" name="sales_type" value="S"> 단품(5권 이하)</label> &nbsp;&nbsp;&nbsp;
                            <label for="m_type"><input type="radio" name="sales_type" value="B"> 대량(6권 이상)</label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea class="ckeditor" name="book_list" id="book_list" rows="8" class="form-control" placeholder="도서상태를 자세히 적어주시고 원하는 판매 금액을 적어주세요."></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-8">
                            <button type="submit" class="btn btn-info" id="sale_req">판매신청</button>
                        </div>
                    </div>
                </form>
            </div>
	    ...
	    <script type="text/javascript">
	    	...
	    	CKEDITOR.replace('book_list', config);
	    </script>
