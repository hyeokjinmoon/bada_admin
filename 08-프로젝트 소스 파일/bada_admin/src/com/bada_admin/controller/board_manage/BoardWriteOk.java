...
@WebServlet("/board_manage/board_write_ok.do")
public class BoardWriteOk extends BaseController {
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			noticeFaqService.insertBoard(noticeFaq);
		} catch (Exception e) {
		...
		web.redirect(web.getRootPath() + "/board_manage/board_view.do?category=" + noticeFaq.getCategory() + "&id=" + noticeFaq.getId(), "게시물이 등록되었습니다.");
