    ...
    <ul class="nav nav-sidebar">
        ...
        <li>
            ...
            <ul class="nav nav-sidebar-inner collapse" id="collapse-item-board">
	            ...
	            <li>
	                <a href="${pageContext.request.contextPath}/board_manage/board_list.do?category=notice">공지사항</a>
	            </li>
	            <li>
	                <a href="${pageContext.request.contextPath}/board_manage/board_list.do?category=faq">자주묻는질문</a>
	            </li>
            </ul>
        </li>
        <li>
