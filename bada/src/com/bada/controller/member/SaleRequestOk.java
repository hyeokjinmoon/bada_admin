...
@WebServlet("/member/sale_request_ok.do")
public class SaleRequestOk extends BaseController {

	private static final long serialVersionUID = 5832602183755499020L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			salesRequestService.insertSalesRequest(salesRequest);
		} catch (Exception e) {
