...
@WebServlet("/board_manage/qna_delete.do")
public class QnaDelete extends BaseController {

	private static final long serialVersionUID = 2719919174938717529L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		web.redirect(web.getRootPath() + "/board_manage/qna_list.do", "삭제되었습니다.");
		return null;
	}
