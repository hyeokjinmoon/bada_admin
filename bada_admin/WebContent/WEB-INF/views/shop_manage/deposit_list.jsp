					...
					<ul class="pagination">
						...
						<c:choose>
							<c:when test="${pageHelper.prevPage > 0}">
								...
								<c:url var="prevUrl" value="/shop_manage/deposit_list.do">
						...
						<c:forEach var="i" begin="${pageHelper.startPage}" end="${pageHelper.endPage}" step="1">
							...
							<c:url var="pageUrl" value="/shop_manage/deposit_list.do" >
						...
						<c:choose>
							<c:when test="${pageHelper.nextPage > 0}">
								...
								<c:url var="nextUrl" value="/shop_manage/deposit_list.do">
