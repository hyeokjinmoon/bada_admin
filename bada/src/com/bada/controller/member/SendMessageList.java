...
@WebServlet("/member/send_message_list.do")
public class SendMessageList extends BaseController {

	private static final long serialVersionUID = -6427431662068496451L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			totalCount = messageService.selectSendMessageCount(message);
			...
			messageList = messageService.selectSendMessageList(message);
		} catch (Exception e) {
		...
		return "member/send_message_list";
	}
